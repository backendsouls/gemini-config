...
- Pre-installed `context7`, `superpowers`, `conductor`, and `open-aware` Gemini extensions in the base sandbox.
...
- **Decision**: Pre-install `context7`, `superpowers`, `conductor`, and `open-aware` extensions.
  - **Rationale**: User request to include specific Gemini extensions in the sandbox environment to enhance capabilities, orchestration, and code awareness.
