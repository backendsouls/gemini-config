...
- Pre-installed `context7` Gemini extension in the base sandbox.
...
- **Decision**: Pre-install `context7` extension.
  - **Rationale**: User request to include specific Gemini extensions in the sandbox environment.
